    ...
    <>
      <div className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-40 py-5 sm:py-10 min-h-screen flex flex-col relative overflow-hidden">
        ...
        >
          ...
          >
            Your One-Stop Solution for PWD ID Creation and Verification
          </h1>
          <p
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-5 mt-10 md:mt-20 w-full">
          ...
          >
            ...
            <p className="font-[inter] text-[#6F6F75] text-center text-sm">
              ...
              and submit the required documentation through our secure portal.
            </p>
          </div>
          <div
          ...
          >
            ...
            <p className="font-[inter] text-[#6F6F75] text-center text-sm">
              Our team will carefully review your application and verify your
              identity. This process typically takes 1-3 business days to
              complete.
            </p>
          </div>
          <div
          ...
          >
            ...
            <p className="font-[inter] text-[#6F6F75] text-center text-sm">
              Access all UPID benefits including streamlined verification across
              services, enhanced security features, and simplified digital
              transactions.
            </p>
          </div>
        </div>
      ...
      <div className="bg-blue-500/10 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-40 py-8 sm:py-15">
        <div className="flex flex-col md:flex-row flex-wrap gap-8 md:gap-10">
          <div className="flex flex-col flex-1 min-w-[200px]">
            <img src={MainLogo} className="max-h-9 max-w-24" alt="UPID Logo" />
            <p className="mt-4 text-sm text-gray-600">
              Providing innovative solutions for PWD ID creation and
              verification.
            </p>
          </div>
